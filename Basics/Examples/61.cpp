// Add two complex numbers with tenary operator
#include <iostream>
using namespace std;
...
int main(){
    ...
    // calling add function and store result in complexSum
    complexSum = addComplexNumbers(num1,num2);

    // use Ternary operator to check sign of the imaginary number
    signOfImag = (complexSum.imag>0)? '+' : '-';

    // adjust sign of imagNum
